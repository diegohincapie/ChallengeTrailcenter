...
jQuery('#save_form_button').click(function (event) {
  ...
  if (jQuery('#book-name').val() == '' || jQuery('#book-year').val() == '') {
    /*jQuery('#save-book-form .alert-danger').html('Please fill al fields').removeClass('d-none');*/
    ...
    jQuery.ajax({
      ...
      jQuery('#save-book-form .alert-success').html('Book saved successfully!').removeClass('d-none');
    }).fail(function (response) {
      jQuery('#save-book-form .alert-danger').html('an error has occurred, please review the information').removeClass('d-none');
    });
  } else {
    jQuery.ajax({
...
jQuery("#libraries").autocomplete({
  ...
  select: function select(event, ui) {
    ...
    jQuery('#librarieslist #library' + ui.item.id + '  i').click(function (event) {
      jQuery('#librarieslist #library' + ui.item.id).remove();
    });
  }
});
...
function addToast(message, color) {
  jQuery('body').append('<div data-autohide="true" class="toast align-items-center text-white bg-' + color + ' border-0" role="alert" aria-live="assertive" aria-atomic="true"><div class="d-flex"><div class="toast-body">' + message + '</div></div></div>');
...
jQuery(document).ready(function () {
  ...
  function loadBook(id) {
    jQuery.ajax({
      ...
      response.book.libraries.forEach(function (item, i) {
        ...
        jQuery('#libraries').val('');
        jQuery('#librarieslist #library' + item.id + '  i').click(function (event) {
          jQuery('#librarieslist #library' + item.id).remove();
        });
      });
  ...
  window.booksFormatter = function (value, row, index) {
    return ['<a class="libraries" href="javascript:void(0)" title="See Libraries"><i class="fa-solid fa-book"></i> See libraries</a>', '<a class="edit" href="javascript:void(0)" title="Edit"><i class="fa-solid fa-pen"></i> Edit book</a>', '<a class="delete" href="javascript:void(0)" title="Delete"><i class="fa-solid fa-rectangle-xmark"></i> Delete book</a>'].join('&nbsp;/&nbsp;');
  };

  window.booksEvents = {
    'click .libraries': function clickLibraries(e, value, row, index) {
      loadLibraries(value);
    },
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/forms.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/tablas.js")))
